...
define(['utilities/global', 'controllers/application', 'models/api', 'models/netsuite'], function(){
	...
	var definitions = (function(){
		...
		_this =  {
			...
			getDefinitions : function(slugs){
				if(slugs.length > 0){
					return _api.request(_this, 'getDefinitions', 'getDefinitions', JSON.stringify({'slugs' : slugs}));
				}
			},
